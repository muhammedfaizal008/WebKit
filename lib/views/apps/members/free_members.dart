                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoCard([
                        ...
                        _buildDetailRow("Partner Age", user.partnerAge.toString()),
                        _buildDetailRow("Partner Education", user.partnerEducation ?? "-"),
                        _buildDetailRow("Partner Profession", user.partnerProfession ?? "-"),
                        _buildDetailRow("Partner Location", user.partnerLocation ?? "-"),
                      ]),
                      ...
                      MySpacing.height(12),
                      _buildInfoCard([
                        _buildDetailRow("Created At", Utils.getDateStringFromDateTime(
                          user.createdAt,
                          showMonthShort: true,
                        )),
                        _buildDetailRow("Updated At", user.updatedAt != null
                          ? Utils.getDateStringFromDateTime(user.updatedAt!, showMonthShort: true)
                          : "-"),
                      ]),
                    ],
                  ...
                  children: [
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: BorderSide(color: contentTheme.primary.withOpacity(0.5)),
