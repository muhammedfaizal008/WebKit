...
import 'package:webkit/controller/apps/members/profile_attributes/gender_controller.dart';
...
class _GenderState extends State<Gender> with UIMixin{
  late GenderController controller;
  TextEditingController genderController = TextEditingController();
  @override
  void initState() {
    controller = Get.put(GenderController());
    super.initState();
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  MyText.titleMedium("Gender", fontWeight: 600),
                  MyBreadcrumb(
                    children: [
                      MyBreadcrumbItem(name: "Users"),
                      MyBreadcrumbItem(name: "Gender", active: true),
                    ],
                  ),
                ],
              ),
            ...
            MyFlex(children: [
              MyFlexItem(
                ...
                child: PaginatedDataTable(
                         ...
                         borderRadiusAll: 10,
                                ...
                                child: Padding(
                                  ...
                                  children: [
                                    ...
                                    children: [
                                      ...
                                      onPressed: () async {
                                        final newStatus = GenderController.text.trim();
                                        if (newStatus.isNotEmpty) {
                                          Get.back();
                                          controller.addGender(name: GenderController.text);
                                        }
                                      },
                                      ),
                                    ],
                          ...
                          child:Row(
                            children: [
                              ...
                              MySpacing.width(10),
                              MyText.bodyMedium("Add Gender",color: Colors.white),
                            ],
                          ))
                      ],
                    ),
                  ...
                  source:
                      GenderDataSource(controller.GenderList, controller),
                  columns: [
                    DataColumn(
...
class GenderDataSource extends DataTableSource {
  final List<GenderModel> gender;
  final GenderController controller;

  GenderDataSource(this.gender, this.controller);

  @override
  DataRow? getRow(int index) {
    if (index >= gender.length) return null;
    final Gender = gender[index];
        ...
        DataCell(Row(
            ...
            MyButton(
              ...
              await FirebaseFirestore.instance
                ...
                .delete()
                .then((_) {
                Get.snackbar("Success", "Gender deleted successfully");
                controller.fetchGender(); // Refresh list
              }).catchError((error) {
                Get.snackbar("Error", "Failed to delete Gender: $error");
              });
              },
            ),
            ],
  ...
  @override
  int get rowCount => gender.length;
