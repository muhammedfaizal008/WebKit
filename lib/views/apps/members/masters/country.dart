...
import 'package:webkit/controller/apps/members/profile_attributes/country_controller.dart';
...
class _CountryState extends State<Country> with UIMixin{
  ...
  Widget build(BuildContext context) {
    return Layout(
      child: GetBuilder<CountryController>(builder: (controller) {
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  MyText.titleMedium("Country", fontWeight: 600),
                  MyBreadcrumb(
                    children: [
                      MyBreadcrumbItem(name: "Users"),
                      MyBreadcrumbItem(name: "Country", active: true),
                    ],
                  ),
                ],
              ),
                ...
                child: PaginatedDataTable(
                  ...
                  header: ConstrainedBox(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        MyText.titleMedium("All Country"),
                        Spacer(),
                        MyButton(
                         ...
                         borderRadiusAll: 10,
                                ...
                                child: Padding(
                                  ...
                                  children: [
                                    ...
                                    children: [
                                      ...
                                      onPressed: () async {
                                        final newStatus = CountryController.text.trim();
                                        if (newStatus.isNotEmpty) {
                                          Get.back();
                                          controller.addCountry(name: CountryController.text);
                                        }
                                      },
                                      ),
                                    ],
                          ...
                          child:Row(
                            children: [
                              ...
                              MySpacing.width(10),
                              MyText.bodyMedium("Add Country",color: Colors.white),
                            ],
                          ))
                      ],
                    ),
                  ...
                  source:
                      CountryDataSource(controller.CountryList, controller),
                  columns: [
                    DataColumn(
...
class CountryDataSource extends DataTableSource {
  ...
  CountryDataSource(this.country, this.controller);

  @override
  DataRow? getRow(int index) {
    if (index >= country.length) return null;
    final Country = country[index];
        ...
        DataCell(Row(
            ...
            MyButton(
              ...
              await FirebaseFirestore.instance
                ...
                controller.fetchCountry(); // Refresh list
              }).catchError((error) {
                Get.snackbar("Error", "Failed to delete Country: $error");
              });
              },
            ),
            ],
  ...
  @override
  int get rowCount => country.length;
