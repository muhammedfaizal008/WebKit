...
class _SmokingHabitsState extends State<SmokingHabits> with UIMixin {
                      ...
                      children: [
                        ...
                        MyButton(
                         ...
                         borderRadiusAll: 10,
                          ...
                          child:Row(
                            children: [Icon(LucideIcons.userPlus,color: Colors.white,),
                              MySpacing.width(10),
                              MyText.bodyMedium("Add SmokingHabits",color: Colors.white),
                            ],
                          ))
                      ],
                    ),
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(MyText.titleSmall(SmokingHabits.isActive==true?"Active":"Inactive")),
        DataCell(Row(
            children: [
            MyButton(
              borderRadiusAll: 8,
                    ...
                    children: [
                      ...
                      flex: 1,
                        child: DropdownButtonFormField<bool>(
                          ...
                          onChanged: controller.onSmokingHabitStatusChanged
                        ),
                      ),
                    ],
                    ),
                    ...
                    Row(
                      ...
                      MyButton(
                        ...
                        if (newName.isNotEmpty) {
                          ...
                          controller.editSmokingHabitStatus(SmokingHabits.id,controller.selectedSmokinghabitStatus!); 
