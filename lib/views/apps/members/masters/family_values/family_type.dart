  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(MyText.titleSmall(FamilyType.isActive==true?"Active":"Inactive")),
        DataCell(Row(
            children: [
            MyButton(
              borderRadiusAll: 8,
                    ...
                    children: [
                      ...
                      flex: 1,
                        child: DropdownButtonFormField<bool>(
                          ...
                          onChanged: controller.onfamilyTypeStatusChanged
                        ),
                      ),
                    ],
                    ),
                    ...
                    Row(
                      ...
                      MyButton(
                        ...
                        if (newName.isNotEmpty) {
                          ...
                          controller.editFamilyTypeStatus(FamilyType.id,controller.selectedfamilyTypeStatus!);  
                        }
                        },
                      ),
                      ],
