  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(MyText.titleSmall(ZodiacSign.isActive==true?"Active":"Inactive")),
        DataCell(Row(
            children: [
            MyButton(
              borderRadiusAll: 8,
                    ...
                    children: [
                      ...
                      flex: 1,
                        child: DropdownButtonFormField<bool>(
                          ...
                          onChanged: controller.onzodiacSignChanged
                        ),
                      ),
                    ],
                    ),
                    ...
                    Row(
                      ...
                      MyButton(
                        ...
                        if (newName.isNotEmpty) {
                          ...
                          controller.editzodiacSignStatus(ZodiacSign.id,controller.selectedzodiacSignStatus!);  
                        }
                        },
                      ),
                      ],
